...
angular.module('starter', ['ionic','ngIOS9UIWebViewPatch', 'starter.controllers', 'starter.services', 'ngMaterial', 'ngMessages', 'ngCordova'])
    ...
    .config(function ($ionicConfigProvider, $stateProvider, $urlRouterProvider, $mdThemingProvider, $mdIconProvider, $mdColorPalette, $mdIconProvider) {
        ...
        appPrimaryColor = $mdColorPalette[$mdThemingProvider._THEMES.default.colors.primary.name]["700"]; //Use for get base color of theme.
        ...
        $stateProvider
            ...
            .state('app.noteslist', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/note/html/note-list.html",
                        controller: 'notesListCtrl'
                    }
                }
            })

            .state('app.notesdetail', {
                url: "/notesdetail",
                params:{
                    isAnimated:true,
                    id:null
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/note/html/note-detail.html",
                        controller: 'notesDetailCtrl'
                    }
                }
            })

			.state('app.notesupdate', {
                url: "/notesupdate",
                params:{
                    isAnimated:true,
                    id:null
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/note/html/note-update.html",
                        controller: 'notesUpdateCtrl'
                    }
                }
            })
			...
			.state('app.notificationlist', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/notification/html/notification-list.html",
			...
			.state('app.profileview', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/profile-view/html/profile-view.html",
...
.state('app.editprofile', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/profile-view/html/edit-view.html",
            ...
            .state('app.todolist', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/todo/html/todo-list.html",
            ...
            .state('app.tododetail', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/todo/html/todo-detail.html",
            ...
            .state('app.calendarlist', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/calendar/html/calendar-list.html",
						controller: 'calanderCtrl'
                    }
                }
            })

        .state('app.calendarnew', {
                        url: "/calendarnew",
                        params:{
                            isAnimated:true,
                            id:null
                        ...
                        views: {
                            'menuContent': {
                                templateUrl: "templates/calendar/html/calendar-new.html",
                                controller:'NewCalanderCtrl'
                            }
                        }
                    })
            .state('app.calendarupdate', {
                url: "/calendarupdate",
                params:{
                    isAnimated:true,
                    id:null
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/calendar/html/calendar-update.html",
                        controller:'UpdateCalanderCtrl'
                    }
                }
            })
            ...
            .state('app.calendarview', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/calendar/html/calendar-view.html",
                        controller:'CalanderDetailsCtrl'
                    }
                }
            })
            ...
            .state('app.updatetodo', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/todo/html/todo-update.html",
            ...
            .state('app.newsFeedDetail', {
                ...
                views: {
                    'menuContent': {
                        templateUrl: "templates/themes/news-feed/html/news-detail.html",
        ...
        $urlRouterProvider.otherwise(window.localStorage.getItem('usertoken')==null ? 'app/fakeLogin' : 'app/menuDashboard');
